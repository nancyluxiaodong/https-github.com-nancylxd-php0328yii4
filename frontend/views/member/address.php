...
<div class="main w1210 bc mt10">
    ...
    <div class="content fl ml10">
        <div class="address_hd">
            <h3>收货地址薄</h3>
            <?php $n=1;foreach ($address as $value):?>
                <dl class="last"> <!-- 最后一个dl 加类last -->
                    <dt><?= $n++.'. '.$value->name.'  '.$value->province.' '.$value->city.' '.$value->county.''.$value->detail.' '.$value->tel;?> </dt>
                    <dd>
            ...
            <ul>
                ...
                <li>
                    <div style="display:none;">
                        ...
                        <?php echo $form->field($model,'county')->hiddenInput(['id'=>"zone" ]);?>
                    </div>
                    <label for="">所在地区：</label>
                    <div class="info">
                        <div>
                            <select id="s_province" class="txt" name="province"></select>  
                            <select id="s_city" class="txt" name="city" ></select> 
                            <select id="s_county" class="txt" name="county"></select>
                ...
                <li>
                    <?php echo $form->field($model,'detail')->textInput(['class'=>'txt']);?>
                </li>
                <li>
                ...
                <li>
                    <label for="">&nbsp;</label>
                    <?php echo $form->field($model,'is_default')->checkbox(['class'=>'check']);?>
                </li>
                <br>
                <li>
                    <label for="">&nbsp;</label>
