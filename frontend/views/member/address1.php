                ...
                <ul>
                    ...
                    <li>
                        ...
                        <div style="display:none;">
                            ...
                            <?php echo $form->field($model,'county')->hiddenInput(['id'=>"county" ]);?>
                        </div>
                    </li>
                    <li>
                       <?= $form->field($model,'detail')->textInput(['class'=>'txt address']);?>
                    </li>
                    <li>
                    ...
                    <li>
                        <label for="">&nbsp;</label>
                        <?= \yii\bootstrap\Html::submitButton('保存',['class'=>'btn']);?>
                    </li>
                </ul>
...
<script>
    ...
    $("#city").change(function(i,v){
        ...
        $.each(address,function(i,v){
            if(current_province == v.name){
                $.each(this.city,function(j,k){
                    if(current_city == k.name){
                        var html = '<option value="">=请选择区/县=</option>';
                        $.each(k.area,function(m,n){
                            html += '<option value="">'+this+'</option>';
                        });
                        $("#area").html(html);
                    }
                });
