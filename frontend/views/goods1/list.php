...
<head><?=\Yii::getAlias('@web')?>/<?=\Yii::getAlias('@web')?>/js/
			...
			<div class="goodslist mt10">
				<ul>
					...
					<li>
						<dl>
							<dt>
                                <?php echo \yii\bootstrap\Html::a(\yii\bootstrap\Html::img($model->logo),['goods/show','id'=>$model->id]);?>
                            </dt>
                            <dd><a href=""><?=$model->name?></a></dd>
